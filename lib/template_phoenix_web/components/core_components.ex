defmodule TemplatePhoenixWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TemplatePhoenixWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TemplatePhoenixWeb.Gettext, "errors", msg, opts)
    end
  end
