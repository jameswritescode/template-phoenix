...
config :template_phoenix, TemplatePhoenixWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "+sAUgcrQ0T9g4CP6YwF+uMf4HjGgJB+8TVMamy7JpavBimyVtyie6IMAw/KM1Tib",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:template_phoenix, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:template_phoenix, ~w(--watch)]}
  ]
...
config :template_phoenix, dev_routes: true
